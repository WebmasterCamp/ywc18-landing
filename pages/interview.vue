  ...
  <ThemeProvider :name="currTheme">
    <InfoContainer class="interview-intro">
      ...
      <a
        ...
        target="_blank"
        ><b>อาคาร ซี.พี.ทาวเวอร์ 1 (สีลม) ชั้น 11</b></a
      ><br />
      ...
      <ol>
        <li>
          ...
          (เพื่อใช้แลกบัตรเข้าอาคาร ซี.พี.ทาวเวอร์ 1 (สีลม)) และ<span
            class="themeText"
            >บัตรประจำตัวนักศึกษา</span
          >หรือบัตรประจำตัวที่หน่วยงานราชการหรือสถานศึกษาปัจจุบันออกให้และมีรูปถ่ายของผู้สัมภาษณ์
          (เพื่อประกอบการลงทะเบียนเข้าสัมภาษณ์)
        </li>
        <li>
          <span class="themeText"
            >แต่งกายด้วยชุดนักเรียน นักศึกษา หรือชุดสุภาพ</span
          >
        </li>
        <li>
      ...
      <a class="themeLink" href="https://m.me/ywcth" target="_blank"
