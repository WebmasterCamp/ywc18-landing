<template>
  <ThemeProvider :name="currTheme">
    <InfoContainer class="interview-intro">
      ...
      <span class="themeText">คำแนะนำ</span> : ควรเดินทางด้วยรถโดยสารสาธารณะ หากเดินทางด้วยรถส่วนบุคคล สามารถจอดรถได้ที่อาคาร SCB Park Plaza โดยมีค่าบริการ<span class="themeText">ชั่วโมงละ 100 บาท</span> ซึ่งผู้เข้าสัมภาษณ์จะต้องชำระค่าที่จอดรถด้วยตนเอง
