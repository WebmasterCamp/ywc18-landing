<template>
  <ThemeProvider :name="currTheme">
    <InfoContainer class="interview-intro">
      ...
      <ol>
        <li>
          <span class="themeText">บัตรประจำตัวประชาชนตัวจริง</span>
        ...
        <li>
          ...
          “ใช้สำหรับลงทะเบียนเข้าสัมภาษณ์โครงการ YWC18 เท่านั้น”
          เซ็นรับรองสำเนาถูกต้อง พร้อมกับระบุวันที่ใช้สำเนาบัตรประชาชน (21
          พฤศจิกายน 2563)
          <a
