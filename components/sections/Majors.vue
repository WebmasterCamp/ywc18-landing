    ...
    <section ref="major-section" class="container">
      ...
      <MajorsContainer>
        ...
        <Major
          ...
          :count="major.design"
          :class="{
            blackout: selectMajor !== '' && selectMajor !== 'designer',
          }"
        ...
        >
          <template slot-scope="scope">
            ...
            >
              <template v-slot:content>
                <p>
                  ทำหน้าที่ออกแบบเว็บไซต์ให้สวยงาม เหมาะกับผู้ที่ชอบวาดรูป
                  รักในสีสันและการวางองค์ประกอบต่าง ๆ
                  รับพิจารณาพิเศษสำหรับผู้ที่มีงานอดิเรกแอบวาดรูปในห้องเรียน
                </p>
                <h3>คำถามประจำสาขา</h3>
                <ol>
                  <li>
                    ทำไมเราถึงต้องเลือกน้องให้เข้ามาเป็นหนึ่งใน Young Webmaster
                    Camp สาขา Web Design
                  </li>
                  <li>
                    ยกตัวอย่างเว็บไซต์หรือแอปพลิเคชันที่มีส่วนช่วยสังคมมา 1
                    ตัวอย่าง พร้อมทั้งอธิบายถึงเหตุผลที่เลือก
                  </li>
                  <li>
                    จงยกตัวอย่างเว็บไซต์หน่วยงานภาครัฐที่น้องอยากทำการ Re-design
                    UI และ UX มา 1 เว็บไซต์ พร้อมบอกเหตุผลที่เลือก
                    และบอกจุดที่ควรจะแก้ไข และแนวทางในการแก้ปัญหา 3
                    จุดเป็นอย่างน้อย
                  </li>
        ...
        <Major
          ...
          :class="{
            blackout: selectMajor !== '' && selectMajor !== 'marketing',
          }"
        ...
        >
          <template slot-scope="scope">
            ...
            >
              <template v-slot:content>
                <p>
                  ทำหน้าที่วางกลยุทธ์เพื่อสร้างรายได้ให้กับเว็บไซต์
                  เหมาะกับผู้ที่สนใจในการหาเงินจากช่องทางต่าง ๆ
                </p>
                <h3>คำถามประจำสาขา</h3>
                <ol>
                  <li>
                    จงบอกจุดแข็ง (อย่างน้อย 2 ข้อ) และจุดอ่อน (อย่างน้อย 2 ข้อ)
                    ของสื่อประเภทเว็บไซต์ สำหรับตัวเรา แบรนด์ และธุรกิจ
                    เมื่อเทียบกับสื่อดิจิทัลประเภทอื่น ๆ เช่น
                    โมบายแอปพลิเคชันและโซเชียลมีเดีย เป็นต้น
                  </li>
                  <li>
                    คุณคิดว่าการทำ Marketing กับ Content
                    เหมือนหรือต่างกันอย่างไร
                    และอะไรคือเรื่องที่สำคัญที่สุดของการทำการตลาด
                  </li>
                </ol>
              </template>
            </FullscreenOverlay>
        ...
        <Major
          ...
          :class="{
            blackout: selectMajor !== '' && selectMajor !== 'developer',
          }"
        ...
        >
          <template slot-scope="scope">
            ...
            >
              <template v-slot:content>
                <p>
                  ทำหน้าที่สร้างเว็บไซต์จากการเขียนโค้ด
                  เหมาะกับผู้ที่เขียนโปรแกรมได้ไม่ว่าภาษาไหน ๆ จะ HTML, CSS,
                  JavaScript หรือนอกเหนือจากนี้
                </p>
                <h3>คำถามประจำสาขา</h3>
                <ol>
                  <li>
                  ...
                  <li>
                    ให้ออกแบบระบบจองห้องประชุมของห้องสมุดมหาวิทยาลัย โดยให้ระบุ
                    Feature ที่อยากให้มี, เทคโนโลยีที่จะเลือกใช้,
                    โครงสร้างของฐานข้อมูล และ Wireframe ของหน้าจอแบบคร่าว ๆ
                  </li>
                  <li>
                    จงเขียน function cardAt ที่รับค่า n
                    และคืนค่าเป็นเลขของไพ่ในสำรับลำดับที่ n โดยเรียงตามดอกไพ่
                    (C, D, H, S) และเลขไพ่ (2, 3, 4, 5, 6, 7, 8, 9, 0, J, Q, K,
                    A) ตามลำดับ ตัวอย่างเช่น cardAt(0) = 2C, cardAt(1) = 3C,
                    cardAt(34) = 0H และ cardAt(35) = JH เป็นต้น
                    โดยเขียนคำตอบมาโดยใช้ภาษาใดก็ได้ หรือเป็น Pseudocode
                    ก็ได้เช่นกัน
                  </li>
                </ol>
              </template>
