    ...
    return {
      ...
      gurus: [
        ...
        },
        {
          ...
          role: `หัวหน้างานส่งเสริมเศรษฐกิจดิจิทัล ฝ่ายส่งเสริมและสนับสนุนการพัฒนาคุณภาพชีวิตและความมั่นคง<br> สำนักงานส่งเสริมเศรษฐกิจดิจิทัล (depa)`,
          majors: [],
          order: 5,
        },
        {
        ...
        {
          img: 22,
          name: 'ศิรณัชชา วุฒิประพันธ์พงศ์ (โอ๋)',
        ...
        {
          img: 25,
          name: 'ภัทราวุธ ซื่อสัตยาศิลป์',
          role: `CTO - LINE MAN Wongnai`,
          majors: ['programming'],
          order: 25,
        },
        {
          img: 26,
          name: 'สิงขร เทพยสุวรรณ',
          role: `Head of Tech - Thairath Online`,
          majors: ['programming'],
          order: 26,
        },
        {
