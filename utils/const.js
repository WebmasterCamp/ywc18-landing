...
export const INTERVIEW_QUESTIONS = {
  content: `<ul><li>การบ้าน 1 ข้อ</li><li>ให้น้องนำมาส่งวันสัมภาษณ์</li></ul><p>
  <b class="themeText">เหตุการณ์</b> : ในสถานการณ์ความแตกต่างของวัยที่ปัจจุบันมีความคิดต่าง ที่ทำให้เกิด Generation Gap มากขึ้นเรื่อยๆ ทั้งเรื่องการเมือง, LGBT, การแสดงออก, การแต่งกาย, ค่านิยมในการใช้ชีวิต และอีกมากมาย
