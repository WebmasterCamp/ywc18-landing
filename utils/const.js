...
export const AGENDA = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        time: '11:20 - 11:30 น.',
        events: ['ชี้แจงรายละเอียดการลงพื้นที่เก็บข้อมูลจริงจากผู้ใช้'],
      },
      {
        time: '11:30 - 11:50 น.',
      ...
      {
        time: '11:50 - 15:20 น.',
        events: ['ลงพื้นที่เก็บข้อมูลจริงจากผู้ใช้'],
      },
      {
        time: '15:20 - 15:30 น.',
        events: ['พักรับประทานอาหารว่าง'],
      },
      { time: '15:30 - 18:20 น.', events: ['ชี้แจงรายละเอียดกิจกรรมวันถัดไป'] },
  ...
  },
  {
    ...
    items: [
      { time: '9:00 - 9:20 น.', events: ['ลงทะเบียนเข้าร่วมกิจกรรมวันที่ 3'] },
      {
        time: '9:20 - 10:05 น.',
        events: [
          `Panel Discussion หัวข้อ “ วางแผนการทำงานของวงการดิจิทัลในปี 2021 ”<br>โดย <b>BrikL</b>, <b>Thairath Online</b> และ <b>LINE MAN Wongnai</b>
     `,
        ],
      },
      {
  ...
  },
  {
    ...
    items: [
      { time: '9:00 - 9:20 น.', events: ['ลงทะเบียนเข้าร่วมกิจกรรมวันที่ 4'] },
      {
        time: '9:20 - 10:05 น.',
        events: [
          `Panel Discussion หัวข้อ “เทคนิคการนำเสนอผลงานอย่างมืออาชีพ ”<br>โดย <b>Pantip</b>, <b>CampHUB</b> และ <b>Easy Rice</b>`,
        ],
      },
